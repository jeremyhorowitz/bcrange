...
this is where i am up to. i need to redo all maps. 
1 subset data for pac left and right that has fix points by species listed in pac_merge 3
...
write.csv(pac_mbg_combine,"output/pac_mbg_combine.csv")
...
write.csv(pac_left_unsuit1_minmax,"output/pac_left_unsuit1_minmax.csv")
write.csv(pac_right_unsuit1_minmax,"output/pac_right_unsuit1_minmax.csv")
...
write.csv(pac_rich_merge,"output/pac_rich_merge.csv")
...
7. run this to analyze richness with latitude
7a. Atlantic Ocean
...
6. run this to analyze richness with latitude
6b. Indian Ocean
