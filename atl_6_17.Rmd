...
p1<-ggplot(pac_merge3,aes(mid_depth,bathy_range),label=species1)+
  geom_point()+
  stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
      scale_y_continuous(trans='log2')+
...
p2<-ggplot(pac_merge3,aes(mid_depth,area))+
  geom_point()+
  stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
      scale_y_continuous(trans='log2')+
...
attach(atl_merge4)
p1b<-ggplot(atl_merge4,aes(absmidlat1d,latrange1d))+
  geom_point()+
  stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
  xlim(0,70)+
...
p2b<-ggplot(atl_merge4,aes(absmidlat1d,planarextent1dgeog))+
  geom_point()+
  stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
  xlim(0,70)+
...
p3b<-ggplot(atl_merge4,aes(absmidlat1d,planarextent2d))+
  geom_point()+
  stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
  xlim(0,70)+
...
pac_temp_combine<-merge(pac_2d_lat_rich,pac_geog_lat_rich,by="y")

ggplot(pac_temp_combine,aes(y))+
geom_line(aes(y=richness,color="richness_2d"),size=1)+  
geom_line(aes(y=richness2d,color="richness_geog"),size=1)+
xlab(label="latitude (degrees)")+
ylab("Richness")+
theme_classic()

ggsave(filename="pac_lat_rich_working.tiff",path="figs/")
