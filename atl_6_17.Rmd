...
three_lat_trends<-ggplot(data=atl_lat_all3,aes(mid,area,colour=type))+
geom_point()+
...
ggsave(filename="three_lat_trends.tiff",path="figs/")
...
pred_lat_plot<-ggplot(data=cbind(atl_lat_all3,pred),
       aes(mid,area,color=type))+geom_point()+
  facet_grid(.~type)+geom_line(aes(y=pred))
pred_lat_plot

ggsave(filename="pred_lat_plott.tiff",path="figs/")
