...
attach(atl_merge4)
p1a<-ggplot(atl_merge4,aes(middepth1d,depthrange1d),label=species1)+
  geom_point()+
  #stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
  #xlim(0,5500)+
  #geom_text(aes(label=ifelse(middepth2d==5212.5|middepth2d==735.5,as.character(species1),'')),hjust=0,vjust=0)+
...
p2a<-ggplot(atl_merge4,aes(middepth1d,planarextent2d))+
  geom_point()+
  #stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
  #xlim(0,5500)+
    scale_y_continuous(trans='log2')+
    scale_x_continuous(trans='log2')+
  #geom_text(aes(label=ifelse(middepth2d==5212.5|middepth2d==667.5,as.character(species1),'')),hjust=0,vjust=0)+
  labs(x = "log mid depth of planar area",y="log planar range extent")+
  geom_smooth(method='lm',se=F)

comb<-p2a+geom_point(aes(y=depthrange1d))
comb

combine<-ggplot(atl_merge4,aes(middepth1d,depthrange1d))+
  geom_point()+
  geom_smooth(method='lm',se=F)+
  scale_y_continuous(trans='log2')+
  scale_x_continuous(trans='log2')+
  labs(x="species' mid-depth",y="bathymetric extent")+
  theme_classic()
combine2<-combine+geom_point(atl_merge4,aes(middepth1d,planarextent2d))+  geom_smooth(method='lm',se=F)
  
  geom_point(aes(y=planarextent2d),color="blue",size=1.5)+
  geom_smooth(method='lm',se=F)+
  scale_y_continuous(trans='log2')+
  scale_x_continuous(trans='log2')+
  labs(x="species' mid-depth",y="bathymetric extent")+
...
g.bottom<-ggplot(atl_merge4,aes(x=middepth1d,y=depthrange1d))+
  geom_point()+
  geom_point(aes(y=planarextent2d),color="blue",size=1.5)+
  scale_y_continuous(expand=c(0,0),limits=c(0,5,000))+
  scale_y_continuous(trans='log2')+
  scale_x_continuous(trans='log2')+
  labs(x="species' mid-depth",y="bathymetric extent")+
  theme_classic() +
...
g.y<-ggplot(atl_merge4, aes(x=middepth1d,y=planarextent2d))+
  theme_classic()+
...
print(g.y, vp=vp2)
ggsave(filename="test.tiff",path="figs/")


lm(depthrange1d~middepth1d)
 model<-lm(depthrange1d~middepth1d)
par(mfrow=c(2,2)) 
plot(model)
Ma1<-lm(formula=depthrange1d~middepth1d)
summary(Ma1)
Ma2<-lm(depthrange1d~middepth1d,subset=(1:length(depthrange1d)!=1))
summary(Ma2)

lm(planarextent2d~middepth1d)
model<-lm(planarextent2d~middepth1d)
par(mfrow=c(2,2)) 
plot(model)
Mb1<-lm(formula=planarextent2d~middepth1d)
summary(Mb1)
Mb2<-lm(planarextent2d~middepth1d,subset=(1:length(planarextent2d)!=1))
summary(Mb2)

p1a
ggsave(filename="atl_range_depth_range.tiff",path="figs/")
p2a
ggsave(filename="atl_range_depth_planar.tiff",path="figs/")
...
p1a<-ggplot(ind_merge4,aes(middepth1d,depthrange1d),label=species1)+
  geom_point()+
  #stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
  #xlim(0,5500)+
...
#2d atl area vs mid depth
p2a<-ggplot(ind_merge4,aes(middepth1d,planarextent2d))+
  geom_point()+
  #stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
  #xlim(0,5500)+
...
p1a
ggsave(filename="ind_range_depth_range.tiff",path="figs/")
p2a
ggsave(filename="ind_range_depth_planar.tiff",path="figs/")
...
p1<-ggplot(pac_merge4,aes(mid_depth,bathy_range),label=species1)+
  geom_point()+
 # stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
      scale_y_continuous(trans='log2')+
...
p2<-ggplot(pac_merge4,aes(mid_depth,area))+
  geom_point()+
#  stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
      scale_y_continuous(trans='log2')+
...
comb<-p2+geom_point(aes(y=bathy_range))
comb

lm(bathy_range~mid_depth)
model<-lm(bathy_range~mid_depth)
par(mfrow=c(2,2)) 
plot(model)
Ma1<-lm(formula=bathy_range~mid_depth)
summary(Ma1)
Ma2<-lm(depthrange1d~middepth1d,subset=(1:length(depthrange1d)!=1))
summary(Ma2)

lm(area~mid_depth)
model<-lm(area~mid_depth)
par(mfrow=c(2,2)) 
plot(model)
Mb1<-lm(formula=area~mid_depth)
summary(Mb1)
Mb2<-lm(planarextent2d~middepth1d,subset=(1:length(planarextent2d)!=1))
summary(Mb2)
...
p1
ggsave(filename="pac_range_depth_range.tiff",path="figs/")
p2
ggsave(filename="pac_range_depth_planar.tiff",path="figs/")
...
attach(atl_merge5)
p1b<-ggplot(atl_merge5,aes(absmidlat1d,latrange1d))+
  geom_point()+
#  stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
 xlim(0,70)+
...
p2b<-ggplot(atl_merge5,aes(absmidlat1d,planarextent1dgeog))+
  geom_point()+
 # stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
  xlim(0,70)+
    ...
    scale_x_continuous(trans='log2')+
  #geom_text(aes(label=ifelse(middepth2d==735.5|middepth2d==59.5,as.character(species1),'')),hjust=0,vjust=0)+
  labs(x = "log mid lat of geographic range",y="log geographic range extent")+
      geom_smooth(method='lm',se=F)

#2d atl area vs mid lat
p3b<-ggplot(atl_merge5,aes(absmidlat1d,planarextent2d))+
  geom_point()+
 # stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
#  xlim(0,70)+
...
comb<-p2b+geom_point(aes(y=planarextent2d))
comb
ggsave(filename="combineplot.tiff",path="figs/")

lm(latrange1d~absmidlat1d)
model<-lm(latrange1d~absmidlat1d)
par(mfrow=c(2,2)) 
plot(model)
Ma1<-lm(latrange1d~absmidlat1d)
summary(Ma1)
Ma2<-lm(depthrange1d~middepth1d,subset=(1:length(depthrange1d)!=1))
summary(Ma2)

lm(planarextent1dgeog~absmidlat1d)
model<-lm(planarextent1dgeog~absmidlat1d)
par(mfrow=c(2,2)) 
plot(model)
Ma1<-lm(planarextent1dgeog~absmidlat1d)
summary(Ma1)
Ma2<-lm(depthrange1d~middepth1d,subset=(1:length(depthrange1d)!=1))
summary(Ma2)

lm(planarextent2d~absmidlat1d)
model<-lm(planarextent2d~absmidlat1d)
par(mfrow=c(2,2)) 
plot(model)
Ma1<-lm(planarextent2d~absmidlat1d)
summary(Ma1)
Ma2<-lm(depthrange1d~middepth1d,subset=(1:length(depthrange1d)!=1))
summary(Ma2)
...
p1b
ggsave(filename="atl_range_latitude_extent.tiff",path="figs/")
p2b
ggsave(filename="atl_range_latitude_geog.tiff",path="figs/")
p3b
ggsave(filename="atl_range_latitude_2d.tiff",path="figs/")
...
```{r}
attach(ind_merge4)
p1b<-ggplot(ind_merge4,aes(absmidlat1d,latrange1d))+
  geom_point()+
  #stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
      scale_y_continuous(trans='log2')+
...
#1d geog extent vs mid lat
p2b<-ggplot(ind_merge4,aes(absmidlat1d,log(planarextent1dgeog)))+
  geom_point()+
 # stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
      scale_y_continuous(trans='log2')+
...
#2d atl area vs mid lat
p3b<-ggplot(ind_merge4,aes(absmidlat1d,planarextent2d))+
  geom_point()+
 # stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
      scale_y_continuous(trans='log2')+
...
p1b
ggsave(filename="ind_range_latitude_extent.tiff",path="figs/")
p2b
ggsave(filename="ind_range_latitude_geog.tiff",path="figs/")
p3b
ggsave(filename="ind_range_latitude_2d.tiff",path="figs/")
...
p1<-ggplot(pac_merge4,aes(abs_mid_lat,lat_range))+
  geom_point()+
 # stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
  #xlim(-1,4)+
...
#1d geog extent vs mid lat
p2<-ggplot(pac_merge4,aes(abs_mid_lat,area_geog_combine))+
  geom_point()+
 # stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
  #xlim(-1,4)+
...
#2d atl area vs mid lat
p3<-ggplot(pac_merge4,aes(abs_mid_lat,area))+
  geom_point()+
#  stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
 #xlim(-1,4)+
...
lm(lat_range~abs_mid_lat)
model<-lm(lat_range~abs_mid_lat)
par(mfrow=c(2,2)) 
plot(model)
Ma1<-lm(lat_range~abs_mid_lat)
summary(Ma1)
Ma2<-lm(depthrange1d~middepth1d,subset=(1:length(depthrange1d)!=1))
summary(Ma2)

lm(area_geog_combine~abs_mid_lat)
model<-lm(area_geog_combine~abs_mid_lat)
par(mfrow=c(2,2)) 
plot(model)
Ma1<-lm(area_geog_combine~abs_mid_lat)
summary(Ma1)
Ma2<-lm(depthrange1d~middepth1d,subset=(1:length(depthrange1d)!=1))
summary(Ma2)

lm(area~abs_mid_lat)
model<-lm(area~abs_mid_lat)
par(mfrow=c(2,2)) 
plot(model)
Ma1<-lm(area~abs_mid_lat)
summary(Ma1)
Ma2<-lm(depthrange1d~middepth1d,subset=(1:length(depthrange1d)!=1))
summary(Ma2)
...
p1
ggsave(filename="pac_range_latitude_extent.tiff",path="figs/")
p2
ggsave(filename="pac_range_latitude_geog.tiff",path="figs/")
p3
ggsave(filename="pac_range_latitude_2d.tiff",path="figs/")
...
plotting bound alone
```{r}



  
attach(bound_type_test)

  bound_test<-ggplot(bound_type_test,aes(x=mid_depth,y=area))+ geom_point()+
  geom_smooth(data=subset(bound_type_test,species=="bound"),aes(x=mid_depth,y=area,color="red"),method="lm",formula=y~poly(x,2),se=F)+
  #scale_y_continuous(trans='log2')+
  #scale_x_continuous(trans='log2')+
  facet_wrap(~type,ncol=1,scales="free")
  
  bound_test
  ggsave(filename="bound_atl.tiff",path="figs/")
...
library(quantreg)
  ...
  atl_subset<-subset(atl_ranges,ocean=="atl")
  atl_lat_range_subset<-subset(atl_subset,type=="lat_geog_range")
  atl_lat_range_subset<-subset(atl_lat_range_subset,!(species=="bound"))
 ...
 # atl_lat_range_subset<-atl_lat_range_subset %>% mutate(area=area+5)
  ...
  atl_lat_geog_plot<-ggplot(data=atl_lat_range_subset,aes(mid,area))+
    geom_point()+
    geom_point(color=ifelse(atl_lat_range_subset$species=="bound","red","black"))+
  scale_y_continuous(trans='log2')+
  scale_x_continuous(trans='log2')+
...
library(quantreg)
  ...
  atl_subset<-subset(atl_ranges,ocean=="atl")
  atl_lat_range_subset<-subset(atl_subset,type=="lat_planar_range")
  atl_lat_range_subset<-subset(atl_lat_range_subset,!(species=="bound"))
 ...
 # atl_lat_range_subset<-atl_lat_range_subset %>% mutate(area=area+5)
  ...
  atl_lat_planar_plot<-ggplot(data=atl_lat_range_subset,aes(mid,area))+
    geom_point()+
    geom_point(color=ifelse(atl_lat_range_subset$species=="bound","red","black"))+
 scale_y_continuous(trans='log2')+
 scale_x_continuous(trans='log2')+
...
```{r}
z2a<-ggplot(atl_pac_range_size_fix, aes(mid_lat,lat_range,shape==group,color=group,fill=group))+
  geom_smooth(method="lm",se=F)+
  scale_y_continuous(trans='log2')+
  scale_x_continuous(trans='log2')+
  geom_point(size=3)+
...
z2b<-ggplot(atl_pac_range_size_fix, aes(mid_lat,geog_range,shape==group,color=group,fill=group))+
  geom_smooth(method="lm",se=F)+
  scale_y_continuous(trans='log2')+
  scale_x_continuous(trans='log2')+
  geom_point(size=3)+
...
z2c<-ggplot(atl_pac_range_size_fix, aes(mid_lat,planar_range,shape==group,color=group,fill=group))+
  geom_smooth(method="lm",se=F)+
  scale_y_continuous(trans='log2')+
  scale_x_continuous(trans='log2')+
  geom_point(size=3)+
...
plot_grid(z2a,z2b,z2c, align="v",ncol=1)
ggsave(filename="range_latitude.tiff",path="figs/")
