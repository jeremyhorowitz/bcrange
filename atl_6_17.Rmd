...
atl_merge4<-atl_merge4 %>% mutate(latrange1d=(latrange1d * 11063.51))
...
z1a<-ggplot(atl_pac_range_size2, aes(mid_depth, depth_range,shape==group,color=group,fill=group))+
  geom_smooth(method="lm",se=F)+
  scale_y_continuous(trans='log2')+
  scale_x_continuous(trans='log2')+
  geom_point(size=3)+
  ...
  ylab("depth extent m")+
  facet_wrap(~group)+
  geom_text(aes(label=ifelse(mid_depth==932.250,as.character(species),'')),hjust=0,vjust=0)

z1a
z1b<-ggplot(atl_pac_range_size2, aes(mid_depth, planar_range,shape==group,color=group,fill=group))+
  geom_smooth(method="lm",se=F)+
  scale_y_continuous(trans='log2')+
  scale_x_continuous(trans='log2')+
  geom_point(size=3)+
...
z2a<-ggplot(atl_pac_range_size2, aes(mid_lat,lat_range,shape==group,color=group,fill=group))+
  geom_smooth(method="lm",se=F)+
  scale_y_continuous(trans='log2')+
  scale_x_continuous(trans='log2')+
  geom_point(size=3)+
...
z2b<-ggplot(atl_pac_range_size2, aes(mid_lat,geog_range,shape==group,color=group,fill=group))+
  geom_smooth(method="lm",se=F)+
  scale_y_continuous(trans='log2')+
  scale_x_continuous(trans='log2')+
  geom_point(size=3)+
  ...
  ylab("lat extent m")+
  facet_wrap(~group,ncol=1)+
  geom_text(aes(label=ifelse(mid_depth==1655.250,as.character(species),'')),hjust=0,vjust=0)

z2b

z2c<-ggplot(atl_pac_range_size2, aes(mid_lat,planar_range,shape==group,color=group,fill=group))+
  geom_smooth(method="lm",se=F)+
  scale_y_continuous(trans='log2')+
  scale_x_continuous(trans='log2')+
  geom_point(size=3)+
  ...
  ylab("lat extent m")+
  facet_wrap(~group,ncol=1)+
  geom_text(aes(label=ifelse(mid_depth==905.000,as.character(species),'')),hjust=0,vjust=0)
