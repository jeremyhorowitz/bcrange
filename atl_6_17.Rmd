...
p2a<-ggplot(atl_merge4,aes(middepth2d,planarextent2d))+
  geom_point()+
  stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
  xlim(0,5500)+
...
#2d atl area vs mid depth
p2a<-ggplot(ind_merge4,aes(middepth2d,planarextent2d))+
  geom_point()+
  stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
  xlim(0,5500)+
...
p2<-ggplot(pac_merge3,aes(depth,area))+
  geom_point()+
  stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
      scale_y_continuous(trans='log2')+
...
p2b<-ggplot(atl_merge4,aes(absmidlat1dgeog,planarextent1dgeog))+
  geom_point()+
  stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
  xlim(0,70)+
...
p3b<-ggplot(atl_merge4,aes(absmidlat2d,planarextent2d))+
  geom_point()+
  stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
  xlim(0,70)+
...
#2d atl area vs mid lat
p3b<-ggplot(ind_merge4,aes(absmidlat2d,planarextent2d))+
  geom_point()+
  stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
      scale_y_continuous(trans='log2')+
...
#1d geog extent vs mid lat
p2<-ggplot(pac_merge4,aes(abs_y_median,area_geog_combine))+
  geom_point()+
  stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
  #xlim(-1,4)+
...
#2d atl area vs mid lat
p3<-ggplot(pac_merge4,aes(abs_decimalLat,area))+
  geom_point()+
  stat_quantile(quantiles=c(.01,.99))+
  theme_classic()+
 #xlim(-1,4)+
